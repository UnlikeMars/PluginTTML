...
public class PsiTeletypeHyperlinkImpl extends ASTWrapperPsiElement implements PsiTeletypeHyperlink {

  public PsiTeletypeHyperlinkImpl(@NotNull ASTNode node) {
    super(node);
  }
