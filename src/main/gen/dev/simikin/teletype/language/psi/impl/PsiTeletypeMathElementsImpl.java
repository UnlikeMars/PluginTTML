...
public class PsiTeletypeMathElementsImpl extends ASTWrapperPsiElement implements PsiTeletypeMathElements {

  public PsiTeletypeMathElementsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiTeletypeVisitor visitor) {
    visitor.visitMathElements(this);
  }
