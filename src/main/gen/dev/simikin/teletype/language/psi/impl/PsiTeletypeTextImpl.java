...
public class PsiTeletypeTextImpl extends ASTWrapperPsiElement implements PsiTeletypeText {

  public PsiTeletypeTextImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiTeletypeMathElements getMathElements() {
    return findChildByClass(PsiTeletypeMathElements.class);
  }
